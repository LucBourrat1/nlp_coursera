...
def main():
    ...
    with open("./C2_W2/data/WSJ_02-21.pos", 'r') as f:
        training_corpus = f.readlines()
        
    # read the vocabulary data, split by each line of text, and save the list
    with open("./C2_W2/data/hmm_vocab.txt", 'r') as f:
        voc_l = f.read().split('\n')
    ...
    with open("./C2_W2/data/WSJ_24.pos", 'r') as f:
        y = f.readlines()
        
    #corpus without tags, preprocessed
    _, prep = preprocess(vocab, "./C2_W2/data/test.words")
    ...
    # test the predict_pos function
    accuracy_predict_pos = predict_pos(prep, y, emission_counts, vocab, states)
    print(f"Accuracy of prediction using predict_pos is {accuracy_predict_pos:.4f}")
    
    # test of create_transition_matrix
    alpha = 0.001
    ...
    # test of the viterbi_forward function
    ...
    # Run and test your function viterbi_backward
